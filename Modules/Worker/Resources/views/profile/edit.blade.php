            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile text-center">
                        <img class="profile-user-img img-responsive img-circle d-block" src="{{!empty(@$data['worker']->avatar) ? \App\Helpers\Helpers::getUrlUploadFile($data['worker']->avatar) : asset('static/images/user2-160x160.jpg')}} " alt="User profile picture">

                        <a href="{{route('worker.change_password')}}" class="btn btn-info mt-5">
                            パスワード変更
                        </a>
...
@endsection
@section('validation')
    {!! JsValidator::formRequest('Modules\Worker\Http\Requests\UpdateProfileRequest', '#form-update') !!}
@endsection
@section('extra-css')
    <style>
