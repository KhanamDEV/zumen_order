 ...
 */
?>
@extends('worker::layouts.layout_login')
    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body pt-0">
            <p class="login-box-msg pb-0 mb-4" style="border-bottom: 1px solid #ccc">
                <img class="w-100" src="{{asset('static/images/worker_login.png')}}" alt="">
            </p>
...
@endsection
@section('validation')
    {!! JsValidator::formRequest('Modules\Worker\Http\Requests\WorkerLoginRequest', '#form-login') !!}
@endsection
