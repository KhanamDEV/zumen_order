                    ...
                    <div class="active tab-pane" id="settings">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="form-create">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{@$data['company']->name}}" class="form-control" id="name" name="name">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="short_name" class="col-sm-2 control-label">略名<b style="color: red;">*</b></label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{@$data['company']->short_name}}" cl class="form-control" id="short_name" name="short_name">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="address" class="col-sm-2 control-label">住所<b
                                        style="color: red;">*</b></label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{@$data['company']->address}}" class="form-control" id="inputName" placeholder=""
                                           name="address">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="phone_number" class="col-sm-2 control-label">電話番号 <b
                                        style="color: red;">*</b></label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{@$data['company']->phone_number}}" class="form-control" id="" placeholder="" name="phone_number">
                                </div>
                            </div>
                            <div class="form-group">
