...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <a href="{{route('admin.worker.create')}}" class="btn btn-success btn-icon-split mb-2">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered" id="table-worker">
                            ...
                            @foreach($data['workers'] as $key => $worker)
                                <tr >
                                    <td><a href="{{route('admin.worker.edit', ['id' => $worker->id])}}">{{$key + 1}}</a></td>
                                    <td><a href="{{route('admin.worker.edit', ['id' => $worker->id])}}">{{@$worker->first_name}}</a></td>
